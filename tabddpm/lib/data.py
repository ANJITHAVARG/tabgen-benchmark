...
CatEncoding = Literal['one-hot', 'counter', 'pre_encoded']
...
def transform_dataset(
    ...
    if dataset.X_cat is None:
        ...
        X_cat = None
    elif transformations.cat_encoding == 'pre_encoded':
        # Skip re-encoding, use X_cat as-is (already label-encoded)
        X_cat = dataset.X_cat
        is_num = False
        cat_transform = None
    else:
